...
class WeighingRepositoryImpl(private val dao: WeighingDao, private val tombstoneDao: SyncTombstoneDao) : WeighingRepository {
    ...
    override suspend fun delete(weighing: WeighingEntity) {
        tombstoneDao.insert(SyncTombstoneEntity(SyncCollections.WEIGHING, weighing.id))
        dao.delete(weighing)
    }
}
